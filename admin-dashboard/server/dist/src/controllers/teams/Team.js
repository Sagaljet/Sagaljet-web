...
exports.uploadMiddleware = exports.deleteTeam = exports.updateTeam = exports.updateTeamOrder = exports.getTeam = exports.createTeam = void 0;
...
const updateTeamOrder = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        // Loop & update each
        const updatePromises = newOrder.map((member) => prisma.team.update({
            where: { id: member.id },
...
exports.updateTeamOrder = updateTeamOrder;
// Update team
